...
.legend-dot.operational { background: var(--series-2); }
.legend-dot.labor { background: var(--series-3); }
.legend-dot.overhead { background: var(--series-4); }
...
.bar-segment.operational { background: var(--series-2); }
.bar-segment.labor { background: var(--series-3); }
.bar-segment.overhead { background: var(--series-4); }
